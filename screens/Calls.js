    ...
    return(
        <SafeAreaView className="bg-white h-full">
           <View className="bg-white pt-3 flex-row justify-between">
                <Text className="pb-4 pl-3 text-2xl text-">Calls</Text>
            ...
            <View>
                ...
                <View className="flex-row ">
                    ...
                    <Text className="mt-5 ml-5 font-bold text-base">Add Favourites</Text>
                </View>
                
                
            </View>
            <View>
                <Text className="ml-3 text-lg font-bold mt-5">Recent</Text>
